...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'common.desktopNavLinks.home' => 'string',
            'common.desktopNavLinks.about.show' => 'string',
            'common.desktopNavLinks.contact.show' => 'string',
            'common.desktopNavLinks.products.all' => 'string',
            'common.desktopNavLinks.login' => 'string',
            'common.mobileNavLinks.login' => 'string',
            'common.mobileNavLinks.home' => 'string',
            'common.mobileNavLinks.about.show' => 'string',
            'common.mobileNavLinks.contact.show' => 'string',
            'common.mobileNavLinks.products.all' => 'string',
            'common.footerNavLinks.home' => 'string',
            'common.footerNavLinks.about.show' => 'string',
            'common.footerNavLinks.contact.show' => 'string',
            'common.footerNavLinks.products.all' => 'string',
            'common.footerNavLinks.privacy.show' => 'string',
            'common.social_links.0.name' => 'string',
            'common.social_links.0.url' => 'string',
            'common.social_links.0.icon' => 'string',
            'common.social_links.0.label' => 'string',
            'common.social_links.1.name' => 'string',
            'common.social_links.1.url' => 'string',
            'common.social_links.1.icon' => 'string',
            'common.social_links.1.label' => 'string',
            'common.social_links.2.name' => 'string',
            'common.social_links.2.url' => 'string',
            'common.social_links.2.icon' => 'string',
            'common.social_links.2.label' => 'string',
            'common.featured_brands.0.image' => 'string',
            'common.featured_brands.0.alt' => 'string',
            'common.featured_brands.1.image' => 'string',
            'common.featured_brands.1.alt' => 'string',
            'common.featured_brands.2.image' => 'string',
            'common.featured_brands.2.alt' => 'string',
            'common.featured_brands.3.image' => 'string',
            'common.featured_brands.3.alt' => 'string',
            'common.featured_brands.4.image' => 'string',
            'common.featured_brands.4.alt' => 'string',
            'common.featured_brands.5.image' => 'string',
            'common.featured_brands.5.alt' => 'string',
            ...
            'filesystems.links.C:\Users\garav\Documents\projects\sportswarehouse_laravel\public\storage' => 'string',
...
'cache.prefix','common.desktopNavLinks.home','common.desktopNavLinks.about.show','common.desktopNavLinks.contact.show','common.desktopNavLinks.products.all',
'common.desktopNavLinks.login','common.mobileNavLinks.login','common.mobileNavLinks.home','common.mobileNavLinks.about.show','common.mobileNavLinks.contact.show',
'common.mobileNavLinks.products.all','common.footerNavLinks.home','common.footerNavLinks.about.show','common.footerNavLinks.contact.show','common.footerNavLinks.products.all',
'common.footerNavLinks.privacy.show','common.social_links.0.name','common.social_links.0.url','common.social_links.0.icon','common.social_links.0.label',
'common.social_links.1.name','common.social_links.1.url','common.social_links.1.icon','common.social_links.1.label','common.social_links.2.name',
'common.social_links.2.url','common.social_links.2.icon','common.social_links.2.label','common.featured_brands.0.image','common.featured_brands.0.alt',
'common.featured_brands.1.image','common.featured_brands.1.alt','common.featured_brands.2.image','common.featured_brands.2.alt','common.featured_brands.3.image',
'common.featured_brands.3.alt','common.featured_brands.4.image','common.featured_brands.4.alt','common.featured_brands.5.image','common.featured_brands.5.alt',
...
'filesystems.links.C:\\Users\\garav\\Documents\\projects\\sportswarehouse_laravel\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'home','products.all','product.category','product.show',
'cart.add','cart.remove','cart.view','product.search','contact.show',
'contact.submit','login','about.show','privacy.show','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'aboutUs','cart','components.btn-secondary','components.form-error','components.product-card',
'contactSuccess','contactUs','errors.404','index','layouts.app',
'login','partials._copyrightsSection','partials._footerNavigation','partials._footerProductsCategories','partials._footerSection',
'partials._footerSocialMedia','partials._navigationSection','partials._productsFilter','partials._productsSearch','privacy',
'productDetails','viewProducts','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'C:.Users.garav.Documents.projects.sportswarehouse_laravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
