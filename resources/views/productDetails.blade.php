...
@section('content')
  ...
  <div class="product-detail-page">
    <div class="product-detail">
      ...
      <!-- RIGHT COLUMN: Product detail and commercial buttons -->
      <div class="product-detail__info">
        <span class="product-detail__category">Category #{{ $product->categoryId }}</span>
        ...
        <div class="product-detail__prices">
          @if ($product->saleprice)
            <div class="product-detail__price-row">
              ...
              <span class="product-detail__old-price">WAS ${{ number_format($product->price, 2) }}</span>
            </div>
          @else
